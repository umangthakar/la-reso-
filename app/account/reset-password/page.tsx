...
// ============================================================
// Le Rasa Bakery — set a new password (/account/reset-password)
// Reached from the reset email via /auth/callback, which has already
// established the recovery session. Without that session there's nothing
// to update, so we send the customer back to request a fresh link.
// ============================================================
...
export default function ResetPasswordPage() {
  ...
  // Once the password is changed, drop the customer into their account.
  useEffect(() => {
    if (!done) return;
  ...
  const cardClass =
    "w-full max-w-md rounded-clay bg-blush-50 p-7 shadow-clay sm:p-9";
      ...
      <div className="container relative flex justify-center">
        ...
        >
          {!ready ? (
            ...
            /* No recovery session — the link was used, expired, or opened in a
